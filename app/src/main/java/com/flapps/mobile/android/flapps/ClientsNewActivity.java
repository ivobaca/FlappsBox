...
public class ClientsNewActivity extends BackIconActivity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_clientsnew);
		...
		*/
		...
		if ( value != 0) {
			cb = new DataModel(ClientsNewActivity.this).getClients().get(value);
			
			EditText et1 = (EditText) findViewById(R.id.client_name);
			et1.setText(cb.getName());
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.clientsnew, menu);
		mainmenu = menu;
	 ...
	 public boolean onOptionsItemSelected(MenuItem item)
	 {
		switch (item.getItemId())
	     ...
	     case R.id.action_send:
		     	...
		     	EditText et1 = (EditText) findViewById(R.id.client_name);
		     	cb.setName(et1.getText().toString());
		     	
				try {
					cb.save(ClientsNewActivity.this);
					finish();
				} catch (TransformerConfigurationException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
					Toast.makeText(ClientsNewActivity.this, "TransformerConfigurationException", Toast.LENGTH_LONG).show();
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
					Toast.makeText(ClientsNewActivity.this, "IOException", Toast.LENGTH_LONG).show();
				} catch (ParserConfigurationException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
					Toast.makeText(ClientsNewActivity.this, "ParserConfigurationException", Toast.LENGTH_LONG).show();
				} catch (SAXException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
					Toast.makeText(ClientsNewActivity.this, "SAXException", Toast.LENGTH_LONG).show();
				} catch (TransformerException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
					Toast.makeText(ClientsNewActivity.this, "TransformerException", Toast.LENGTH_LONG).show();
				}
		         return true;
